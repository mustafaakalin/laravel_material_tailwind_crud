...
<div class="relative flex flex-col text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
    ...
    <form class="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96" action="{{ route('employee.update', $employee2->id) }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="flex flex-col gap-6 mb-1">
            ...
            <img src="/images/{{ $employee2->photo }}" alt="" class="rounded-md w-52">
            ...
            <div class="relative h-11 w-full min-w-[200px]">
                <input placeholder="John Michael"
                    class="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent !border-t-blue-gray-200 bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:!border-t-gray-900 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                    type="text" name="name" value="{{ $employee2->name }}" />
            ...
            <div class="relative h-11 w-full min-w-[200px]">
                <input placeholder="Manager"
                    class="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent !border-t-blue-gray-200 bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:!border-t-gray-900 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                    type="text" name="job" value="{{ $employee2->job }}" />
                    @error('job')
                    <div class="text-red-500 mt-2 text-sm">
                        {{ $message }}
                    </div>
            ...
            <div class="relative h-11 w-full min-w-[200px]">
                <input type="date" placeholder="12/11/2021"
                    class="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent !border-t-blue-gray-200 bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:!border-t-gray-900 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                    name="employed" value="{{ $employee2->employed }}" />
                    @error('employed')
                    <div class="text-red-500 mt-2 text-sm">
                        {{ $message }}
                    </div>
